...
public class Application extends Controller {
    ...
    public static Result dashboard() {
        ...
        return ok(views.html.page.homePage.render(_numJobsAnalyzed, _numJobsSevere, _numJobsCritical,
    ...
    public static Result search() {
        ...
        if (!appId.isEmpty()) {
            ...
            return ok(views.html.page.searchPage.render(null, jobDetails.render(result)));
            ...
            return ok(views.html.page.searchPage.render(null, views.html.results.flowDetails.render(flowExecPair, map)));
            ...
            return ok(views.html.page.searchPage.render(null, views.html.results.flowDefinitionIdDetails.render(flowDefIdPair, map)));
        }
        ...
        if (results.isEmpty() || currentPage > paginationStats.computePaginationBarEndIndex(results.size())) {
            return ok(views.html.page.searchPage.render(null, jobDetails.render(null)));
        } else {
            ...
            return ok(views.html.page.searchPage.render(paginationStats, views.html.results.searchResults.render(
    ...
    public static Result compare() {
        ...
        return ok(views.html.page.comparePage.render(views.html.results.compareResults.render(compareFlows(results1, results2))));
    }
    ...
    private static Result getFlowHistory(Version version) {
        ...
        if (!Utils.isSet(partialFlowDefId)) {
            if (version.equals(Version.NEW)) {
                return ok(views.html.page.flowHistoryPage
                        .render(partialFlowDefId, graphType, views.html.results.flowHistoryResults.render(null, null, null, null)));
            } else {
                return ok(
                        views.html.page.oldFlowHistoryPage.render(partialFlowDefId, graphType, views.html.results.oldFlowHistoryResults.render(null, null, null, null)));
            }
        }
        ...
        if (version.equals(Version.NEW)) {
            if (graphType.equals("heuristics")) {
                return ok(views.html.page.flowHistoryPage.render(flowDefPair.getId(), graphType,
                ...
                return ok(views.html.page.flowHistoryPage.render(flowDefPair.getId(), graphType, views.html.results.flowMetricsHistoryResults
                        .render(flowDefPair, graphType, executionMap, idPairToJobNameMap, flowExecTimeList)));
            }
        } else {
            if (graphType.equals("heuristics")) {
                return ok(views.html.page.oldFlowHistoryPage.render(flowDefPair.getId(), graphType,
                ...
                if (hasSparkJob) {
                    ...
                    return ok(views.html.page.oldFlowHistoryPage.render(flowDefPair.getId(), graphType, views.html.results.oldFlowMetricsHistoryResults
                            .render(flowDefPair, graphType, executionMap, idPairToJobNameMap, flowExecTimeList)));
                }
            }
        }
    ...
    private static Result getJobHistory(Version version) {
        ...
        if (!Utils.isSet(partialJobDefId)) {
            if (version.equals(Version.NEW)) {
                return ok(
                        views.html.page.jobHistoryPage.render(partialJobDefId, graphType, views.html.results.jobHistoryResults.render(null, null, -1, null)));
            } else {
                return ok(views.html.page.oldJobHistoryPage.render(partialJobDefId, graphType, views.html.results.oldJobHistoryResults.render(null, null, -1, null)));
            }
        }
        ...
        if (version.equals(Version.NEW)) {
            if (graphType.equals("heuristics")) {
                return ok(views.html.page.jobHistoryPage.render(jobDefPair.getId(), graphType,
            ...
            if (graphType.equals("heuristics")) {
                return ok(views.html.page.oldJobHistoryPage.render(jobDefPair.getId(), graphType,
    ...
    private static Result getHelp(Version version) {
        ...
        return ok(views.html.page.oldHelpPage.render(title, page));
    }
    ...
    public static Result restSearch() {
        ...
        if (!appId.isEmpty()) {
            AppResult result = AppResult.find.select("*")
                    ...
                    .findUnique();
            if (result != null) {
                logger.info("AppResult info: " + result.toString());
                return ok(Json.toJson(result));
            } else {
